...
abstract class DetailsRepo {
  Future<Either<Failure, MovieModel>> fetchMovieDetails(int movieId);
}
...
class DetailsRepoImpl implements DetailsRepo {
  ...
  @override
  Future<Either<Failure, MovieModel>> fetchMovieDetails(int movieId) async {
    try {
      var data = await apiServices.get2(endPoint: '$movieDetails$movieId?');
